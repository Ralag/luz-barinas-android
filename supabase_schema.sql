...
-- 4. Idempotent column migrations for existing instances
...
ALTER TABLE public.sectors ADD COLUMN IF NOT EXISTS barrio TEXT;
...
ALTER TABLE public.community_locations ADD COLUMN IF NOT EXISTS barrio TEXT;
